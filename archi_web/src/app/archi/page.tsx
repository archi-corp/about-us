            ...
            <Link href="/archi/minseok" legacyBehavior>
              ...
              >
                <Image
                  ...
                  alt={"강민석"}
                  className={
                    "mx-auto mb-5 rounded-full object-cover sm:size-20 lg:mx-0 lg:size-24 lg:items-start"
                  }
                  width={100}
                  height={100}
                />
