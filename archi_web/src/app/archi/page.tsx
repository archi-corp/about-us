  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-24">
      ...
      <div className="z-10 w-full max-w-7xl items-center justify-between font-mono text-sm lg:flex">
        ...
        &nbsp;
        <div className="fixed right-0 top-0 flex w-full items-center justify-center bg-gradient-to-t from-white via-white lg:static lg:size-auto lg:bg-none dark:from-black dark:via-black">
          <a
          ...
          <Link href="/archi/minseok" legacyBehavior>
            ...
            >
              <Image
                ...
                alt={"강민석"}
                className={
                  "mx-auto mb-5 rounded-full object-cover lg:mx-0 lg:items-start"
                }
                width={100}
                height={100}
              />
