  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <Link href ="/" className="text-4xl font font-thin fixed left-0 top-0 flex w-full justify-center lg:static lg:w-auto  lg:rounded-xl lg:border lg:p-4" > &lt; </Link> &nbsp;
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-5 lg:text-left">
        ...
        <Link href="/archi/rachel" legacyBehavior>
            ...
            <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Project Manager<br /> Backend Developer <br /> Frontend Developer
            </p>
            </div>
        </Link>
