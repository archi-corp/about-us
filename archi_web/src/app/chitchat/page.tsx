...
export default function Chitchat() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start pr-10 pt-10">
      <div className="flex h-full w-full flex-row rounded-tr-xl bg-gradient-to-t from-white via-white lg:bg-none dark:from-black dark:via-black">
        <div className="ml-3 w-32 flex-shrink-0 rounded-t-2xl bg-white">
          상단 네비바{" "}
        </div>
      ...
      <div className="flex w-full flex-row">
        <div className="ml-3 w-32 flex-shrink-0 rounded-b-2xl bg-white">
          {" "}
          네비바{" "}
        </div>
